...
const navGroups: NavGroup[] = [
  ...
  { title: '管理', items: [
    ...
    { href: '/companies', label: '企業管理', roles: ['consultant','admin'], icon: I('M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4') },
    { href: '/courses', label: '課程管理', roles: ['consultant','admin','hr','manager','instructor','supervisor'], icon: I('M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253') },
    ...
    { href: '/knowledge-base', label: '知識庫', roles: ['consultant','admin','hr'], icon: I('M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10') },
  ...
  { title: '營運', items: [
    ...
    { href: '/todos', label: '待辦事項', roles: ['consultant','admin','instructor'], icon: I('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4') },
    ...
    { href: '/survey-results', label: '問卷總覽', roles: ['consultant','admin','hr'], icon: I('M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z') },
    ...
    { href: '/course-interest', label: '課程興趣', roles: ['consultant','admin','hr'], icon: I('M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z') },
  ...
  { title: '專業', items: [
    ...
    { href: '/analyst-cases', label: '個案管理', roles: ['analyst'], icon: I('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01') },
  ]},
  { title: '學習', items: [
...
export function Sidebar({ role, roles, fullName, email, onLogout }: SidebarProps) {
    ...
    <div className="flex flex-col h-full w-56 bg-white border-r border-gray-100">
      ...
      <div className="flex items-center gap-3 px-4 py-4 border-b border-gray-100">
        ...
        <div className="min-w-0">
          <p className="text-sm font-bold text-gray-900">ID3A</p>
          <p className="text-[10px] text-gray-400">管理平台</p>
        </div>
      </div>
      ...
      <div className="border-t border-gray-100 p-3">
        <div className="flex items-center gap-2.5 px-2 py-2">
          <Link href="/profile" className="w-8 h-8 bg-indigo-100 rounded-full flex items-center justify-center flex-shrink-0 hover:bg-indigo-200 transition-colors">
